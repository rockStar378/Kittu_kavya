...
OWNER_USERNAME = getenv("OWNER_USERNAME","@ANKIT_PAWOR")
BOT_USERNAME = getenv("BOT_USERNAME" , "kavya_music_robot")
BOT_NAME = getenv("BOT_NAME" , "˹KAVYA ꭙ ᴍᴜsɪᴄ˼ ♪ [ ᴛᴘʙ ]™")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/rockStar378/Kittu_kavya",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

API_URL = getenv("API_URL", 'https://api.thequickearn.xyz') #youtube song url
API_KEY = getenv("API_KEY", 'NxGBNexGenBotse2b587') # youtube song api ke
